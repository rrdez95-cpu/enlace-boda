...
export default function TabInvitaciones({ data, setData, showToast, userId, bodaId }: Props) {
  ...
  useEffect(() => {
    if (inv?.activa && bodaId) fetchRsvps()
  }, [inv?.activa, bodaId])
    ...
    return (
      <div className="inv-empty">
        ...
        <div className="inv-features">
          ...
          <div className="inv-feat"><span>🔗</span> URL personalizada con vuestros nombres</div>
        </div>
        ...
        {(!data.resumen?.novios) && (
          <p className="inv-warn">
            💡 Añade los nombres de los novios en Resumen general para generar la URL personalizada
          </p>
        )}
      </div>
    )
      ...
      <div className="inv-side">
        ...
        <div className="inv-url-card">
          <div className="inv-url-head">
            ...
            <button className="inv-toggle-btn" onClick={() => updInv({ activa: !inv.activa })}>
      ...
      <div className="inv-main">
        ...
        <div className="inv-block">
          <div className="inv-block-head">
            ...
            <button className="btn-ghost" onClick={fetchRsvps}>↻ Actualizar</button>
          </div>
...
function FotoSlot({ label, hint, url, loading, onFile, onClear, fileRef }: {
  label: string
  hint: string
  url?: string
  loading: boolean
    ...
    <div className="foto-slot">
      ...
      {url ? (
        <div className="foto-preview">
          ...
          <button className="foto-clear" onClick={onClear}>× Quitar</button>
        </div>
      ) : (
